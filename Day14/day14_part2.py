...
def calc_amount(start_qty, start_name):
    ...
    for out_name in plan:
        ...
        # Scan each ingredient, figuring out how much we need. For part 2,
        # the calculation does partial batches with floating point.
        for ing_qty, ing_name in r.ing_list:
            #batch_qty = math.ceil(need_amts[out_name] / out_qty)
            batch_qty = need_amts[out_name] / out_qty
...
def main():
    ...
    n = calc_amount(1, 'FUEL')
    return int(1000000000000 / n)
